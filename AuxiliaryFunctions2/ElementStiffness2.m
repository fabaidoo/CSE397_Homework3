function Ke = ElementStiffness2(quad_rule, P_e_mat, C_e, w_e, span1, span2)
...
for i = 1:length(weights)
    ...
    %Jacobians
    [~, Jx, ~, ~] ...
        = ElementShapeFunctionRoutine2(xi, P_e_mat, C_e, w_e, span1, span2);
    Jphi = Parent2BezierMap(span1, span2);
    
    %BMatrix
    BMat =...
    BMatrix2(xi, P_e_mat, C_e, w_e, span1, span2);
