function Fe = ElementForceVector2(quad_rule, P_e_mat, C_e, w_e, span1, span2)
...
for i = 1:length(weights)
    ...
    %Jacobians
    [~, ~, ~, dxdv_phi] ...
        = ElementShapeFunctionRoutine2([xi1 -1], P_e_mat, C_e, w_e, span1, span2);
    ...
    NMat = NMatrix2([xi1 -1] , C_e, w_e, span1, span2);
