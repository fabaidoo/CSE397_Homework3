function [n_el,C_operators,IEN] = Extract_Basis2(p_1,p_2,n_1,n_2,Xi_1,Xi_2)
% SPECIAL THANKS TO MINYEONG KIM FOR ALLOWING ME TO RE-USE HIS CODE
%Enumeration of extraction operators is different from Minyeong's original
%code
...
for e2=1:D2.n_el
    for e1=1:D1.n_el
        ...
        kron(D1.C_operators(:,:,e1), D2.C_operators(:,:,e2));
    end
end
