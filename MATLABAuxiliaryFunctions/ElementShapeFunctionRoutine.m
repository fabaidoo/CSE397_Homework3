...
[DRephi, Rephi] = ElementNURBSderivative(xi, Ce, we, span1, span2); 
x_phi = P_e_mat' * Rephi;
...
function [DR_e_phi, R_e_phi] = ...
    ElementNURBSderivative(xii, C_e, w_e, span1, span2)
...
p=2;
[Bplus, DBplus]= Bernstein2D(xii, p); %bernsteins on [-1, 1]^2
